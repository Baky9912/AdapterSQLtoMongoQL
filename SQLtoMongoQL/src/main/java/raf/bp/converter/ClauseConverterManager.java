...
public class ClauseConverterManager extends ClauseConverter {
    ...
    public static void main(String[] args) {
        ClauseConverterManager clauseConverter = new ClauseConverterManager();
        ArrayList<String> testingQueries = new ArrayList<>(List.of(
                ...
                "select first_name, last_name from employees where salary = 1000 group by salary asc, date_of_birth desc"
        ));
